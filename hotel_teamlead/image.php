...
if(isset($_POST['btnsave'])){
  ...
  $file=addslashes(file_get_contents($_FILES['user_image']['tmp_name']));
  $query="INSERT INTO tbl_users(userPic) VALUES('$file')";
    ...
    <div class="container body">
      <div class="main_container">
              ...
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-edit"></i> Committee <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="form.html">Publicity Group</a></li>
        ...
        <div class="right_col" role="main">
			<form method="post" enctype="multipart/form-data" class="form-horizontal" action="image.php">
     

			<table class="table table-bordered">
      <tr><td>Image</td></tr>
      <?php
        $query2="SELECT userPic FROM tbl_users ORDER BY userId DESC";
        $result=mysqli_query($con,$query2);
        while($row=mysqli_fetch_array($result)){
          echo '
              <tr>
                <td>
				<a href="data:image/jpeg;base64,'.base64_encode($row["userPic"]).'" target="_blank">
                  <img width="300px" height="300px" src="data:image/jpeg;base64,'.base64_encode($row["userPic"]).'" /></a>
                  </td>
                  </tr>
          ';
        }
     ...
     <td><label class="control-label">Profile Img.</label></td>
        <td><input class="input-group" type="file" name="user_image" accept="image/*" id="image" /></td>
    </tr>
