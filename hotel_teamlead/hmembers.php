            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                ...
                <ul class="nav side-menu">
                  ...
                  <li><a href="CDetail.html"><i class="fa fa-desktop"></i> Assigning Task <span class="fa fa-chevron-down"></span></a>
                  ...
                  <li><a><i class="fa fa-table"></i> Committee Database <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      ...
                      <li><a href="sponsorDetail.html">Sponsorship Hndling Group</a></li>
                      <li><a href="bagDetail.html">Bag Quatation Group</a></li>
                      <li><a href="foodDetail.html">Food Allocation Group</a></li>
                      <li><a href="paperDetail.html">Paper Handling Group</a></li>
                      <li><a href="keynoteDetail.html">Keynote Group</a></li>
                      <li><a href="hotelDetail.html">Hotel Quataion Group</a></li>  
                    </ul>
                  </li>
